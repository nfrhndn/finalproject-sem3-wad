...
export default function Dashboard() {
  ...
  function handleCheckout(
    ...
    const metode = kendaraan.paymentMethod || "QRIS";
    ...
    setLogs((prev) => [
      {
        time: new Date().toLocaleTimeString("id-ID"),
        message: `Kendaraan ${jenis.toUpperCase()} ${nomorPolisi} keluar dari slot ${
          kendaraan.id
        }. Durasi: ${durasi}, Biaya: Rp ${totalBayar.toLocaleString()}, Metode: ${metode}`,
      },
      ...prev,
    ]);
