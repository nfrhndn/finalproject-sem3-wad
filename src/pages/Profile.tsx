    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-cyan-50 flex flex-col items-center py-10 px-4">
      ...
      <div className="bg-white shadow-md rounded-2xl p-8 w-full max-w-2xl">
        <div className="flex items-start justify-between mb-6">
          ...
          {!isEditing && (
            <button
              className="p-2 ml-4 text-gray-500 hover:text-cyan-700"
            ...
            {showDropdown && (
              <div className="border border-gray-200 rounded-lg p-4 mt-2 bg-gray-50 space-y-3 text-sm text-gray-700">
                <p className="text-gray-700">
                  1. Customer Service kami akan menghubungi Anda melalui email
                  terdaftar untuk memverifikasi permintaan penghapusan akun.
                  <br />
                  2. Proses penghapusan akun memakan waktu maksimal 14 hari
                  kerja.
                  <br />
                  3. Setelah penghapusan selesai, akun tidak dapat digunakan
                  kembali untuk pendaftaran.
                </p>
                ...
                <button
                  onClick={() => {
                    alert(
                      "✅ Laporan penghapusan akun telah dikirim ke tim kami."
                    );
                    setShowDropdown(false);
                  }}
          ...
          <div className="space-y-3">
            {languageOptions.map((lang) => (
              <button
                ...
                className={`w-full flex items-center justify-between border border-gray-300 rounded-lg px-4 py-2 hover:bg-cyan-50 ${
              ...
              >
                ...
                {selectedLanguage === lang.name && (
                  <span className="text-cyan-600 font-medium">Dipilih</span>
                )}
              </button>
            ))}
          </div>
      ...
      {activeModal === "terms" && (
        <Modal title="Ketentuan Penggunaan CinemaPlus">
          <div className="text-sm text-gray-600 leading-relaxed space-y-3">
            <p>
              Dengan menggunakan situs <b>CinemaPlus</b>, Anda menyetujui
              ketentuan yang berlaku.
            </p>
            <p>
              Data film, jadwal, dan gambar adalah milik <b>CinemaPlus</b> atau
              pemegang hak sahnya.
            </p>
            <ul className="list-disc pl-6 space-y-1">
              <li>
                Dilarang menggunakan data ini untuk tujuan komersial tanpa izin.
              </li>
              <li>Dilarang menyalin atau membagikan isi situs tanpa izin.</li>
              <li>
                Dilarang menjual atau menyewakan data situs kepada pihak lain.
              </li>
            </ul>
            <p>
              <b>CinemaPlus</b> dapat memperbarui ketentuan ini sewaktu-waktu.
              Periksa versi terbaru secara berkala.
            </p>
          </div>
        </Modal>
      )}
      ...
      {activeModal === "help" && (
        <Modal title="Pusat Bantuan">
          <p className="text-sm text-gray-600">
            Jika Anda mengalami kendala, hubungi kami melalui:
          </p>
